...
class PuestoManager {
   ...
   * @returns {Promise<string | null>} The MongoDB _id (string hex) of the newly created puesto, or null on failure.
   * @throws Will throw an error if the puesto name is duplicate or other database errors occur.
   */
  async createPuesto(data: NewPuestoData): Promise<string | null> {
