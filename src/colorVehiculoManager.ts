...
class ColorVehiculoManager {
   ...
   * @returns {Promise<string | null>} The MongoDB _id (string hex) of the newly created color, or null on failure.
   * @throws Will throw an error if the color name is duplicate or other database errors occur.
   */
  async createColor(data: NewColorVehiculoData): Promise<string | null> {
